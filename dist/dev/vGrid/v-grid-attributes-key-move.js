...
System.register(['aurelia-framework', './v-grid'], function (_export, _context) {
  ...
  var inject, customAttribute, VGrid, _dec, _dec2, _class, vGridAttributesKeyMove;
  ...
  return {
    ...
    execute: function () {
      _export('vGridAttributesKeyMove', vGridAttributesKeyMove = (_dec = customAttribute('v-key-move'), _dec2 = inject(Element, VGrid), _dec(_class = _dec2(_class = function () {
      ...
      _export('vGridAttributesKeyMove', vGridAttributesKeyMove);
    }
  };
});
//# sourceMappingURL=../dist/dev/vGrid/v-grid-attributes-key-move.js.map
