...
System.register(['aurelia-framework', './v-grid'], function (_export, _context) {
  ...
  var inject, noView, customElement, bindable, processContent, TargetInstruction, VGrid, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _class, _desc, _value, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, VGridElementColConfig;
  ...
  return {
    ...
    execute: function () {
      ...
      }), _dec3 = customElement('v-grid-col'), _dec4 = inject(Element, VGrid, TargetInstruction), _dec5 = bindable({ attribute: "col-width" }), _dec6 = bindable({ attribute: "col-field" }), _dec7 = bindable({ attribute: "col-header-name" }), _dec8 = bindable({ attribute: "col-sort" }), _dec9 = bindable({ attribute: "col-filter" }), _dec10 = bindable({ attribute: "col-filter-top" }), _dec11 = bindable({ attribute: "col-add-label-attributes" }), _dec12 = bindable({ attribute: "col-add-filter-attributes" }), _dec13 = bindable({ attribute: "col-add-row-attributes" }), _dec14 = bindable({ attribute: "col-type" }), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (_class2 = function () {
...
//# sourceMappingURL=../dist/dev/vGrid/v-grid-element-col-config.js.map
