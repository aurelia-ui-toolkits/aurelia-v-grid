...
System.register(['aurelia-framework', './v-grid'], function (_export, _context) {
  ...
  var inject, customAttribute, BindingEngine, VGrid, _dec, _dec2, _class, vGridAttributesObserveField;
  ...
  return {
    ...
    execute: function () {
      _export('vGridAttributesObserveField', vGridAttributesObserveField = (_dec = customAttribute('v-observe-field'), _dec2 = inject(Element, VGrid, BindingEngine), _dec(_class = _dec2(_class = function () {
      ...
      _export('vGridAttributesObserveField', vGridAttributesObserveField);
    }
  };
});
//# sourceMappingURL=../dist/dev/vGrid/v-grid-attributes-observe-field.js.map
